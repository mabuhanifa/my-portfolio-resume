...
const SingleProject = () => {
  ...
  return (
    <div className="text-gray-300 mx-40">
      <div className="w-full h-full ">
        <h1 className="my-10 text-4xl font-bold"> {items.name}</h1>
        <p className="my-10 text-xl font-bold">{items.info}</p>
        <div className="flex text-blue-500 text-lg font-[500]">
          <a
            className="flex font-firacode"
            target="_blank"
        ...
        <div className="w-full flex items-center mx-5 mb-10 font-notosans ">
          {items.tech.map((tech) => (
